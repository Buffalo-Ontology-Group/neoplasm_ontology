    ...
    AuthorInit: function () {
        MathJax.Hub.Register.StartupHook("TeX Jax Ready", function () {
            MathJax.InputJax.TeX.prefilterHooks.Add(function (data) {
                ...
                data.math = data.math.replace(/{?\\ss}?/g, "ÃŸ");

                data.math = data.math.replace(/\\"a|{\\"a}|\\"{a}/g, "Ã¤");

                data.math = data.math.replace(/\\"o|{\\"o}|\\"{o}/g, "Ã¶");

                data.math = data.math.replace(/\\"u|{\\"u}|\\"{u}/g, "Ã¼");
                ...
                data.math = data.math.replace(/\\text{\\textbf{([^}]+)}}/g, "\\mathbf{\\text{$1}}");

                data.math = data.math.replace(/\\text{\\textsf{([^}]+)}}/g, "\\mathsf{\\text{$1}}");

                data.math = data.math.replace(/\\text\\EUR/g, "â‚¬");

                data.math = data.math.replace(/\\mathop (.+?)\\limits/g, "\\mathop{$1}\\limits");

                data.math = data.math.replace(/{?\\ss}?/g, "ï¬‚");

                data.math = data.math.replace(/\\"a|{\\"a}|\\"{a}/g, "â€°");

                data.math = data.math.replace(/\\"o|{\\"o}|\\"{o}/g, "Ë†");

                data.math = data.math.replace(/\\"u|{\\"u}|\\"{u}/g, "Â¸");
...
(function () {
    setTimeout(function () {
        ...
        s.async = true;
        s.src = '//cdn.mathjax.org/mathjax/latest/MathJax.js?config=TeX-AMS-MML_HTMLorMML.js';
